         ...
         <!--        <div id="top">
            <div class="container">
                <div class="col-md-6 offer" data-animate="fadeInDown">
                    <a href="#" class="btn btn-success btn-sm" data-animate-hover="shake">Offers</a> <a href="#"> Click here for our awesome offers!</a>
                </div>
         ...
         <nav class="navbar navbar-default">
            <div class="container-fluid">
               ...
               <div class="navbar-header">
                  <a class="navbar-brand home" href="indexOLD.html" data-animate-hover="">
               ...
               <div class="navbar-collapse collapse" id="navigation">
                  <ul class="nav navbar-nav navbar-left">
                     <li class="active"><a href="indexOLD.html">Home</a>
                     </li>
                     <li class="dropdown yamm-fw">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="200">Products <b class="caret"></b></a>
                            ...
                            <?php
                               include 'php/ProductFetcher.php';

                                outputProductCategories(fetch_product_categories());
   ...
   <footer>
      ...
      <div id="copyright">
         <div class="container">
            <div class="col-md-6">
               <p class="pull-left">
                  2016 © Copyright Andrea Montesin
